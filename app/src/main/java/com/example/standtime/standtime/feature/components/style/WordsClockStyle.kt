...
@Composable
private fun WordsClockStylePreview() = ClockStylePreviewFrame { modifier ->
    WordsClockStyle(ClockStylePreviewParts, StandTimeLanguage.ENGLISH, ClockStylePreviewAccent, modifier)
}
